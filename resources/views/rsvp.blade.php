...
@section('vuejs')
    <script>
        ...
        new Vue({
            ...
            computed: {
                urlForSearching: function () { return '/rsvp/' + this.query; },
                urlForSendingRsvp: function() { return '/rsvp/' + this.rsvp.id; },
                isSearching: function () { return this.stage === 'searching'; },
                isResponding: function () { return this.stage === 'responding'; },
                isComplete: function() { return this.stage === 'completed'; },
                enoughInformationSupplied: function() {
                    return ! this.rsvp.is_attending || (
...
@section('content')
    ...
    <div class="container">
        ...
        <div v-show="isComplete" class="alert alert-success">
            <h3>Thanks!</h3>
            <p>Thanks for letting us know! <3</p>
        </div>

        <form v-show="! isComplete" action="" class="rsvp-wrapper">

            <div v-show="isSearching" class="form-group">
                <label>Enter your surname to find your invitation</label>
            ...
            <div v-show="isResponding">
                ...
                <div v-show=" ! rsvp.is_attending">
                    <div class="alert alert-info">Sadness. No worries, please make the evening if you can!</div>
                </div>
                ...
                <div v-show="rsvp.is_attending">
                    ...
                    <div class="form-group">
                        ...
                        <div v-show="rsvp.has_dietry_requirements">
                            <label>Enter your requirements, we'll do our best to sort it.</label>
                            <textarea class="form-control" v-model="rsvp.dietry_requirements" style="max-width: 400px; min-height: 120px"></textarea>
                        </div>
                    </div>

                    <div class="form-group">
                        <label>Any other comments or information we need to know?</label>
                        <textarea class="form-control" v-model="rsvp.comments" style="max-width: 400px; min-height: 120px"></textarea>
                    </div>
